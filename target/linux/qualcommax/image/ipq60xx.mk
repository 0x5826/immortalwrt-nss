...
define Device/jdcloud_re-ss-01-nowifi
	$(Device/jdcloud_re-ss-01)
	DEVICE_MODEL := RE-SS-01-nowifi
	DEVICE_PACKAGES := -ath11k-firmware-ipq6018-ddwrt -kmod-ath11k -kmod-ath11k-ahb -kmod-ath11k-pci -hostapd-common -wpad-openssl -kmod-qca-nss-drv-wifi-meshmgr -ipq-wifi-jdcloud_re-ss-01
...
define Device/link_nn6000-v2-nowifi
	$(Device/link_nn6000-v2)
	DEVICE_MODEL := NN6000 v2-nowifi
	DEVICE_PACKAGES := -ath11k-firmware-ipq6018-ddwrt -kmod-ath11k -kmod-ath11k-ahb -kmod-ath11k-pci -hostapd-common -wpad-openssl -kmod-qca-nss-drv-wifi-meshmgr -ipq-wifi-link_nn6000
	SUPPORTED_DEVICES += link,nn6000-v2
endef
TARGET_DEVICES += link_nn6000-v2-nowifi
